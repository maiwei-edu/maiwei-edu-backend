...
import { CloseIcon, SelectMiaosha, ThumbBar } from "../../../../../components";
...
export const MsV1Set: React.FC<PropInterface> = ({ block, onUpdate }) => {
  ...
  return (
    <div className={styles["vod-v1-box"]}>
      <div className={styles["title"]}>
        <div className={styles["text"]}>秒杀配置</div>
      </div>
