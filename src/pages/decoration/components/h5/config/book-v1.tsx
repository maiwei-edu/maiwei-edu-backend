...
export const BookV1Set: React.FC<PropInterface> = ({ block, onUpdate }) => {
  ...
  return (
    <div className={styles["vod-v1-box"]}>
      <div className={styles["title"]}>
        <div className={styles["text"]}>电子书配置</div>
      </div>
          ...
          <div className={styles["courses-list-box"]}>
            {config.items &&
              ...
              config.items.map((item: any, index: number) => (
                ...
                >
                  {item.thumb ? (
                    <img src={item.thumb} width={60} height={80} />
                  ) : (
                    <img src={editIcon} width={60} height={80} />
                  )}
                  <div
