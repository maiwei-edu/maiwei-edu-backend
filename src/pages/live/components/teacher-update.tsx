...
export const CourseTeacherUpdateDialog = (props: PropsInterface) => {
  ...
  const getDetail = () => {
    live.teacherDetail(props.id).then((res: any) => {
      form.setFieldsValue({
        name: res.data.name,
      ...
      {props.open ? (
        ...
        >
          <div className="float-left mt-30">
            <Form
              form={form}
              name="live-teacher-update-dailog"
              labelCol={{ span: 3 }}
              wrapperCol={{ span: 21 }}
