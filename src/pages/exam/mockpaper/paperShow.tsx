...
const MockPaperReadPage = () => {
  ...
  useEffect(() => {
    document.title = "查看模拟考试";
    dispatch(titleAction("查看模拟考试"));
  }, []);
  ...
  const getData = () => {
    mock.mockPaperJoinRecord(id, pid).then((res: any) => {
...
export default MockPaperReadPage;
